 ...
 * helpers derive the day (j.scheduledStart.slice(0,10)), so the spanning bar,
 * the markers, and the day lists all agree. Mirrors mobile/lib/calendar/spans.ts.
 */
export function jobDays(
  job: Pick<CalendarJob, 'scheduledStart' | 'scheduledEndDate'>,
): string[] {
